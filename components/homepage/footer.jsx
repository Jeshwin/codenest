    ...
    return (
        ...
        >
            <div className="w-full h-fit grid grid-cols-1 gap-y-4">
                <div className="h-fit bg-[var(--light-bg-1)] dark:bg-[var(--dark-bg-1)] rounded-lg p-4">
                ...
                <div className="w-full h-full bg-[var(--light-bg-1)] dark:bg-[var(--dark-bg-1)] rounded-lg p-4">
            ...
            <div className="w-full h-fit bg-[var(--light-bg-1)] dark:bg-[var(--dark-bg-1)] rounded-lg p-4">
