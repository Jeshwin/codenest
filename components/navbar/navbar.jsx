...
export default function Navbar() {
    ...
    return (
        <header className="top-0 flex flex-row gap-1 items-center px-3 py-2 text-black dark:text-white bg-slate-100 dark:bg-slate-800">
            ...
            <div className="h-8 w-8 p-2 flex item-center rounded-xl hover:bg-slate-50 dark:hover:bg-slate-900 active:scale-90 transition duration-150 cursor-pointer">
