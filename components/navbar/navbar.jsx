...
export default function Navbar() {
    return (
        <header className="top-0 flex flex-row gap-1 items-center px-3 py-2 font-sans text-[var(--light-fg-1)] dark:text-[var(--dark-fg-1)] bg-[var(--light-bg-1)] dark:bg-[var(--dark-bg-1)]">
            <Logo />
            <ProjectName />
