...
import {ProjectStructureProvider} from "./porjectStructureProvider";
...
export default function TreeView() {
    ...
    const [showNewElementInput, setShowNewElementInput] =
        ...
        <ProjectStructureProvider initialProjectStructure={projectStructure}>
            <div className="h-full px-3 py-2 flex flex-col font-sans">
                ...
                >
                    ...
                    {currentFile.split("/").length - 1 == 0 && (
                        <NewElement
                            currentFile={currentFile}
                            showNewElementInput={showNewElementInput}
                            setShowNewElementInput={setShowNewElementInput}
                        />
                    )}
