...
export default function WelcomeDialog() {
    ...
    const handleImageUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                setAvatarUrl(reader.result as string); // Set the uploaded image as the new avatar
            };
    ...
    const handleRemoveImage = () => {
        setAvatarUrl(null); // Reset to default avatar
    };
                ...
                >
                    ...
                    <AlertDialogDescription className="flex gap-8">
                        <div className="relative">
                            <Avatar className="size-36 rounded-full mt-2">
                                <AvatarImage
                                    src={
                                        avatarUrl ||
                                        `https://api.toucanny.net/avatar?userid=${
